...
function HyugatsunamiMvt(){
  ...
  this.source = new VectorTileSource({
    ...
    format: new MVT(),
    maxZoom:16,
    url: "https://kenzkenz3.xsrv.jp/mvt/miyazaki/hyuganadatsunami/{z}/{x}/{y}.mvt"
  });
  this.style = hyugaTsunamiStyleFunction()
  this.maxResolution = 2.388657	 //zoom16
}
export const hyugaTsunamiSumm = "<a href='https://data.bodik.jp/dataset/450006_1085/resource/df8fc753-a8c5-4bfe-a739-913559f89ed8' target='_blank'>津波浸水深（日向灘R2）</a>" +
    "<br><img src='https://kenzkenz.xsrv.jp/open-hinata/img/shinsui_legend_popup.png' width='250px'>"
export  const hyugaTsunamiMvtObj = {};
for (let i of mapsStr) {
  hyugaTsunamiMvtObj[i] = new VectorTileLayer(new HyugatsunamiMvt())
}
// ----------------------------------------------------------------------------
function hyugaTsunamiRaster() {
  this.name = 'hyugatsunamiraster'
  this.preload = Infinity
  this.source = new XYZ({
    url: 'https://kenzkenz3.xsrv.jp/mvt/miyazaki/hyuganadatsunamiraster/{z}/{x}/{y}.png',
    crossOrigin: 'anonymous',
    minZoom: 0,
    maxZoom: 15
  })
...
export const hyugaTsunamiRasterObj = {};
for (let i of mapsStr) {
  hyugaTsunamiRasterObj[i] = new TileLayer(new hyugaTsunamiRaster())
}
export const hyugaTsunamiObj = {}
for (let i of mapsStr) {
  hyugaTsunamiObj[i] = new LayerGroup({
    layers: [
      hyugaTsunamiMvtObj[i],
      hyugaTsunamiRasterObj[i]
    ]
  })
...
for (let i of mapsStr) {
  ...
  syochiiki2020Obj[i].values_['pointer'] = true
}
